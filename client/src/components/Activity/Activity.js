...
function Activity(){
    ...
    countries.sort(dynamicSort('name'));
                    ...
                    <div className="formDetails">
                        <div className="col">
                            ...
                            <div>
                                ...
                                <input className="input" name="duration" type='number' min='1' max='20' value={form.duration}  onChange={number => handleChange(number)} placeholder="hours" required/> 
                        ...
                        <div className="col">
                            ...
                            <select className="inputCountries" name="countries" defaultValue={form.countries} onChange={countries => handleChange(countries)} size="10" multiple required>
